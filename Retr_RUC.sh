...
while [ "$day" != 2016-01-01 ]; do
    ...
    filein=/terra/RUC_RAP_252_grb1/$year$month/$year$month$day2/ruc2anl_252_$year$month$day2
    fileout=/gc_runs/RUCRAP_252_Intermediate/ruc2anl_252_$year$month$day2 
    for ((i=0; i<=13; i++));
    do  
