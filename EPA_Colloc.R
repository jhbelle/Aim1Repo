...
Col <- subset(G24hr, G24hr$StudyArea == "Col")[,c("State", "County", "Site", "Latitude", "Longitude", "Date", "X24hrPM")]
write.csv(Col, "T://eohprojs/CDC_climatechange/Jess/Dissertation/EPAcleaned/ColG24hr.csv", row.names=F)
